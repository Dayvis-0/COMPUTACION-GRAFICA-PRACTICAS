...
const fsSource = `
    ...
    void main() {
        gl_FragColor = vec4(0.8, 0.2, 0.2, 0.1);
    }
`
...
// Creacion de primitivas 2D
// Despues de obtener gl
function initBuffer(gl) {
    // Vertices (x, y) de un cuadrado

    const vertices = new Float32Array([
        -0.5, -0.5,   // 0: Inferior izquierdo
        0.5, -0.5,   // 1: Inferior derecho
        0.5, 0.5,    // 2: Superior derecho
        -0.5, 0.5  // 3: Superior izquierdo 
    ]);

    // Indices para dos triangulos
    const indices = new Uint16Array([
        0, 1, 2, // Primer triangulo
        0, 2, 3  // Segundo triangulo
    ]);

    /// Crear buffer con vertices
...
function multiplyMat3(a, b) {
    // a y b son Float32Array de 9 elementos (column-major)
    // Resultado c = a * b
